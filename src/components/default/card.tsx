...
export const Card: (
  props: CardProperties & RefAttributes<ContainerRef>
...
export const CardHeader: (
  props: CardHeaderProperties & RefAttributes<ContainerRef>
...
export const CardContent: (
  props: CardContentProperties & RefAttributes<ContainerRef>
) => ReactNode = forwardRef((props, ref) => {
...
export const CardFooter: (
  props: CardFooterProperties & RefAttributes<ContainerRef>
) => ReactNode = forwardRef((props, ref) => {
  return (
    <Container
      flexDirection="row"
